 ...
 * The count field represents the number of Triangle3DNode's this scene contains.
 */
...
/** 
 * Frees the memory on the heap for the Scene3D itself, as well as the 
...
/**
 * This function should create a bunch of triangles to represent a pyramid in
 * 3D space.
 ...
 *   Parameters:
 *     scene: The scene that the caller wants the triangles added to
...
/**
 * This function should create a bunch of triangles to represent a cuboid in
 * 3D space.
 * The caller is responsible for freeing the memory, or, if this shape gets 
 * added to a Scene3D, that is can be freed when the scene is.
 *   Parameters:
